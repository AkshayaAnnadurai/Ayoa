...
console.log(data,ans,user)
    ...
    return(
        <div>
         ...
         <p id="po">Create your account below to get started.</p>
         ...
         name="password"
           ...
           <label>
           <p>I agree to the Ayoa<span> Terms & Conditions, License Agreement, <br></br>Privacy Policy</span> and consent to receive relevant marketing<br></br> communications. I understand that I am able to change my<br></br><span> email preferences </span>at any time.</p>
           </label>
           </div>
           <br></br>
           <label>
           <input  id="sig" type="Submit" 
           className="form-control" value="SIGN UP ITS FREE" />
           </label> 
            ...
            <p><span>Already have an account?</span><span>Sign in</span></p>
